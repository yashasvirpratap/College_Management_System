...
if(isset($_POST['login'])){
  ...
  $sql="select * from teacherlogin where user='".$uname."'AND pass='".$password."' limit 1";
          ...
          <div class="col-sm-6 text-black">
            ...
            >
              <form style="width: 23rem" method="POST" action="#">
                ...
                <div class="pt-1 mb-4">
                  <button name="login" class="btn btn-info btn-lg btn-block" type="submit" id="login1">
                    Login
                  </button>
                </div>
                ...
                <p>
                  <a href="index.php" class="link-info">Click here</a> to go
                  back to main page
                </p>
              </form>
            </div>
